  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Unlit
    {
      ...
      Program "vp"
      {
        ...
        SubProgram "vulkan"
        {
          // GlobalKeywords: _ALPHAPREMULTIPLY_ON
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Unlit
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat6 = u_xlat0.y * unity_MatrixV[1].z;
          
          u_xlat6 = unity_MatrixV[0].z * u_xlat0.x + u_xlat6;
          
          u_xlat6 = unity_MatrixV[2].z * u_xlat0.z + u_xlat6;
          
          out_v.texcoord1 = u_xlat6 + unity_MatrixV[3].z;
    ...
    Pass // ind: 3, name: DepthNormalsOnly
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          out_f.SV_TARGET0.xyz = float3(u_xlat0_d) * in_f.texcoord1.xyz;
