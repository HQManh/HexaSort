  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = (-_ClipRect.xy) + _ClipRect.zw;
          
          u_xlat0_d.xy = u_xlat0_d.xy + -abs(in_f.texcoord2.xy);
          
          u_xlat0_d.xy = u_xlat0_d.xy * in_f.texcoord2.zw;
          
          u_xlat0_d.xy = clamp(u_xlat0_d.xy, 0.0, 1.0);
          
          u_xlat16_1 = u_xlat0_d.y * u_xlat0_d.x;
          
          u_xlat16_0.x = texture(_MainTex, in_f.texcoord.xy).w;
          
          u_xlat16_6 = u_xlat16_0.x * in_f.texcoord1.x + (-in_f.texcoord1.w);
          
          u_xlat16_6 = clamp(u_xlat16_6, 0.0, 1.0);
          
          u_xlat16_0 = float4(u_xlat16_6) * in_f.color;
          
          u_xlat16_6 = u_xlat16_1 * u_xlat16_0.w;
          
          u_xlat16_2.xyz = float3(u_xlat16_6) * _MaskEdgeColor.xyz;
          
          u_xlat3_d.xyz = u_xlat16_0.xyz * float3(u_xlat16_1) + (-u_xlat16_2.xyz);
          
          u_xlat18 = (_MaskInverse != 0) ? 1.0 : 0.0;
          
          u_xlat16_4 = texture(_MaskTex, in_f.texcoord.zw).w;
          
          u_xlat18 = u_xlat18 + (-u_xlat16_4);
          
          u_xlat4_d = (-_MaskWipeControl) + 1.0;
          
          u_xlat18 = u_xlat4_d * _MaskEdgeSoftness + abs(u_xlat18);
          ...
          u_xlat3_d.xyz = float3(u_xlat18) * u_xlat3_d.xyz + u_xlat16_2.xyz;
          
          u_xlat0_d.xyz = float3(u_xlat18) * u_xlat3_d.xyz;
          
          u_xlat0_d.w = u_xlat16_6 * u_xlat18;
