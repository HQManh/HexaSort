  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = u_xlat16_1.xyz * in_f.color.xyz;
          
          u_xlat0_d.xyz = u_xlat16_1.xyz + u_xlat16_1.xyz;
          
          u_xlat2 = dot(_TintColor.ww, in_f.color.ww);
          
          u_xlat0_d.w = u_xlat16_10 * u_xlat2;
