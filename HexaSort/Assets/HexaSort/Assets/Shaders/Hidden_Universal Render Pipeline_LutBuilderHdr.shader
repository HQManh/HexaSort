  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: LutBuilderHdr
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = u_xlat0_d.xzw * _Lut_Params.www + float3(-0.386036009, -0.386036009, -0.386036009);
      ...
      ;
          ...
          u_xlat10_10.x = texture(_CurveHueVsHue, u_xlat1_d.xy, _GlobalMipBias.x).x;
          
          u_xlat10 = u_xlat10_10.x;
          
          u_xlat10 = clamp(u_xlat10, 0.0, 1.0);
          
          u_xlat1_d.x = u_xlat1_d.x + u_xlat10;
          
          u_xlat1_d.x = u_xlat1_d.x + -0.5;
          ...
          u_xlat16_4.x = max(u_xlat1_d.y, u_xlat1_d.x);
          
          u_xlat16_4.x = max(u_xlat1_d.z, u_xlat16_4.x);
          
          u_xlat16_4.x = u_xlat16_4.x + 1.0;
          
          u_xlat16_4.x = float(1.0) / float(u_xlat16_4.x);
          
          u_xlat0_d.xyz = u_xlat1_d.xyz * u_xlat16_4.xxx + float3(0.00390625, 0.00390625, 0.00390625);
          
          u_xlat0_d.w = 0.0;
          
          u_xlat10_1 = texture(_CurveMaster, u_xlat0_d.xw, _GlobalMipBias.x).x;
          
          u_xlat1_d.x = u_xlat10_1;
          
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0.0, 1.0);
          
          u_xlat10_10.x = texture(_CurveMaster, u_xlat0_d.yw, _GlobalMipBias.x).x;
          
          u_xlat10_10.y = texture(_CurveMaster, u_xlat0_d.zw, _GlobalMipBias.x).x;
          
          u_xlat1_d.yz = u_xlat10_10.xy;
          
          u_xlat1_d.yz = clamp(u_xlat1_d.yz, 0.0, 1.0);
          
          u_xlat0_d.xyz = u_xlat1_d.xyz + float3(0.00390625, 0.00390625, 0.00390625);
          
          u_xlat0_d.w = 0.0;
          
          u_xlat10_1 = texture(_CurveRed, u_xlat0_d.xw, _GlobalMipBias.x).x;
          
          u_xlat1_d.x = u_xlat10_1;
          
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0.0, 1.0);
          
          u_xlat10_10.x = texture(_CurveGreen, u_xlat0_d.yw, _GlobalMipBias.x).x;
          
          u_xlat10_10.y = texture(_CurveBlue, u_xlat0_d.zw, _GlobalMipBias.x).x;
          ...
          u_xlat16_4.xyz = u_xlat1_d.xyz * u_xlat16_4.xxx;
